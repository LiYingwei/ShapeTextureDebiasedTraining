...
def resnext101(baseWidth, cardinality, num_classes=1000, norm_layer=None):
    """
    Construct ResNeXt-101.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 23, 3], num_classes=num_classes, norm_layer=norm_layer)
    return model
